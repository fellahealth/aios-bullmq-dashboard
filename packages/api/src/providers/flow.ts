...
function findBullMQAdapter(queues: QueueRegistry): BullMQAdapter | null {
...
async function getFlowProducer(queues: QueueRegistry): Promise<FlowProducer | null> {
 ...
 */
function buildQueueNameLookup(queues: QueueRegistry): Map<string, BullMQAdapter> {
